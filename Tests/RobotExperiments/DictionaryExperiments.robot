...
#https://github.com/robotframework/robotframework/blob/master/atest/testdata/standard_libraries/builtin/create_dictionary.robot
...
OwnExperiment1
    &{d} =    Create Dictionary
    Set To Dictionary    ${d}    $Testvar1    Testvalue1
    Set To Dictionary    ${d}    $Testvar2    Testvalue2
    Set Test Variable    ${Test}    Testvar3
    Set To Dictionary    ${d}    $${Test}    Testvalue3
    #Get Dictionary Items    ${d}    $Testvar2
    ${value}=    Evaluate    $d.get("$Testvar2")
    Log    ${value}
    ${value}=    Evaluate    $d.get("$Testvar2")
    Log    ${value}
    ${value2}=    Evaluate    $d.get("$Testvar4", "NULL")
    Log    ${value2}
