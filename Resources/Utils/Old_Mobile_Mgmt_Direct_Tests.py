...
from Resources.Utils.DriverSingletonAdapter import (
...
class TestDriverSingletonAdapter(unittest.TestCase):
    """Test cases for DriverSingletonAdapter.py functions."""
