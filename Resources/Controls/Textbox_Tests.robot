...
OldWithXpathInSelectorName_Pixel9Pro_API35_Textbox_Tests_AllModus
...
Pixel9Pro_API35_Textbox_Tests_AllModus
    Setup AUT Pixel9Pro_API35
    TextboxProcessing    dlgLogin    <GET>    txtEmail    //*[@hint='E-MAIL ADRESSE:']    X
    TextboxProcessing    dlgLogin    <SET>    txtEmail    //*[@hint='E-MAIL ADRESSE:']    matthias@matthias-schmotz.de
    TextboxProcessing    dlgLogin    <GET>    txtEmail    //*[@hint='E-MAIL ADRESSE:']    X
    TextboxProcessing    dlgLogin    <CHK>    txtEmail    //*[@hint='E-MAIL ADRESSE:']    matthias@matthias-schmotz.de