...
Enter Vehicle Data for Automobile
    ...
    #Technische Änderung? Verhalten in jedem Fall sehr merkwürdig gewesen - plötzlich auf motorcycle vehicle data
...
Enter Product Data
    #Typisches Datums-Problem
    #Fill Text    id=startdate    06/01/2023
    Fill Text    id=startdate    06/01/2026
...
Send Quote
    ...
    #Keine solche Antwort mehr vorhanden
